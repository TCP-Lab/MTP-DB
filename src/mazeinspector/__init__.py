...
__version__ = "0.0.1"
USAGE = """mazeinspector /path/to/MTP-DB.sqlite"""
DESC = """
Inspects and provides information on the status of an instance of the MTP-DB.
"""
...
# Setup logging
log = logging.getLogger("mazeinspector")  # Keep this at the module level name
